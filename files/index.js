...
const UUID = process.env.UUID || '893fdeeb-b8a8-4dec-88ee-a8e7d938daa9'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.alex.nyc.mn';     
const NEZHA_PORT = process.env.NEZHA_PORT || '1234';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'E8GLbEYo9eq8mKHUOOTOiiAz9N9B3Ar1';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'yxj.zamzhang.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZDU2NDMzZTBhZmI5ODY2ZjZhMGVmOTI2MjdjYzBkMzgiLCJ0IjoiMmUyYjgxNmYtNTFiYy00NWJkLWI0YWYtOTZmYjg4ZTg4NTNmIiwicyI6Ik9UWXpaalZtWlRVdE9XWmtaUzAwTmpNMExXRTFNamt0T0dWaE1UWmtZVEkyWVRjNSJ9';
